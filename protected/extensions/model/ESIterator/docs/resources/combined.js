...
var ApiGen = ApiGen || {};
ApiGen.config = {"require":{"min":"2.8.0"},"resources":{"resources":"resources"},"templates":{"common":{"overview.latte":"readme.md","combined.js.latte":"resources\/combined.js","elementlist.js.latte":"elementlist.js","404.latte":"404.md"},"optional":{"sitemap":{"filename":"sitemap.xml","template":"sitemap.xml.latte"},"opensearch":{"filename":"opensearch.xml","template":"opensearch.xml.latte"},"robots":{"filename":"robots.txt","template":"robots.txt.latte"}},"main":{"package":{"filename":"package-%s.md","template":"package.latte"},"namespace":{"filename":"namespace-%s.md","template":"namespace.latte"},"class":{"filename":"class-%s.md","template":"class.latte"},"constant":{"filename":"constant-%s.md","template":"constant.latte"},"function":{"filename":"function-%s.md","template":"function.latte"},"source":{"filename":"source-%s.md","template":"source.latte"},"tree":{"filename":"tree.md","template":"tree.latte"},"deprecated":{"filename":"deprecated.md","template":"deprecated.latte"},"todo":{"filename":"todo.md","template":"todo.latte"}}},"options":{"elementDetailsCollapsed":true,"elementsOrder":"natural"},"config":"O:\\home\\apigen\\templates\\default\\config.neon"};
 ...
 * http://www.gnu.org/licenses/gpl.md
 *
 */
 ...
 * @license http://www.gnu.org/licenses/gpl.md
...
$.Autocompleter.Select = function (options, input, select, config) {
	...
	function fillList() {
		...
		for (var i=0; i < max; i++) {
			...
			if ( formatted === false )
				continue;
			var li = $("<li/>").md( options.highlight(formatted, term) ).addClass(i%2 == 0 ? "ac_even" : "ac_odd").appendTo(list)[0];
