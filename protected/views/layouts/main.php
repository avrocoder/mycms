...
<head>
	...
	<meta name="language" content="en" />
        <?php echo (!empty($this->pageKeywords)) ?  "<meta name='keywords' content='".CHtml::encode($this->pageKeywords)."' />\n" : ""; ?>
        <?php echo (!empty($this->pageDescription)) ?  "<meta name='description' content='".CHtml::encode($this->pageDescription)."' />\n" : ""; ?>

	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/public/css/reset.css" />
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/public/css/styles.css" />
